...
echo "Testing readfile path traversal:"
test_path_traversal "readfile with .." 'readfile "../../etc/passwd"'
test_path_traversal "readfile with absolute path" 'readfile "/etc/passwd"'
test_path_traversal "readfile with /root" 'readfile "/root/.bashrc"'

echo ""
echo "Testing import path traversal:"
test_path_traversal "import with .." 'import "../../secrets/config"'
test_path_traversal "import with absolute path" 'import "/etc/shadow"'
test_path_traversal "import /var/log" 'import "/var/log/auth.log"'

echo ""
echo "Testing fill_template path traversal:"
test_path_traversal "fill_template with .." 'fill_template "../../config.json" {}'
test_path_traversal "fill_template absolute" 'fill_template "/etc/hosts" {}'
test_path_traversal "fill_template /home" 'fill_template "/home/user/.ssh/id_rsa" {}'
